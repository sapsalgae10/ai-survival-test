    ...
    <main className="min-h-screen bg-white text-black font-sans tracking-tight">
      <nav className="sticky top-0 z-50 bg-white/95 border-b border-gray-100 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-8 h-20 flex items-center justify-between">
          <img src="/logo.png" alt="로고" width={40} height={40} />
          <button
      ...
      {mode === "home" && (
        <section className="relative min-h-[85vh] flex items-center bg-slate-900 text-white px-8 py-16">
          <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="w-full aspect-square relative rounded-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-1000">
              <img
                src="/logo.png"
                alt="로고"
      ...
      {mode === "result" && (
        <section className="max-w-4xl mx-auto px-8 py-32 text-center animate-in zoom-in duration-700">
          ...
          <h2 className="text-7xl font-black my-10 tracking-tighter">
            {survivalRate}%
          </h2>
          ...
          <div className="bg-gray-50 p-10 text-left border-l-4 border-black mb-12">
            ...
            <p className="text-gray-600 leading-relaxed italic text-lg">
              {survivalRate > 80
                ? "경이로운 수준입니다. 당신은 이미 AI를 도구로 부리며 전체를 설계하는 '슈퍼 아키텍트'의 길을 걷고 있습니다."
                : survivalRate > 50
                ? "안정적인 생존권입니다. 다만 특정 기술에 안주하기보다 비즈니스 설계 능력을 더 키울 필요가 있습니다."
          ...
          <button
            onClick={resetTest}
            className="px-12 py-4 bg-black text-white font-bold text-sm"
          >
            테스트 다시하기
          </button>
        </section>
